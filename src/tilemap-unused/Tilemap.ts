import { Bounds, BoundsData, Container, Instruction, MeshGeometry, PointData, Texture, View } from 'pixi.js';
 ...
 */
export class Tilemap extends Container implements View, Instruction {
  ...
  private _updateBounds() {
    ...
    bounds.minX = this.tilemapBounds.minX;
    bounds.maxX = this.tilemapBounds.maxX;

    bounds.minY = this.tilemapBounds.minY;
    bounds.maxY = this.tilemapBounds.maxY;
