import { BufferImageSource, Container, PointData, Texture } from 'pixi.js';
...
export class CompositeTilemap extends Container {
  ...
  // TODO: Add shadow
  // private static shadowColor = new Float32Array([0.0, 0.0, 0.0, 0.5]);
  ...
  tileset(tileTextures?: Array<Texture | undefined>): this {
    ...
    // const texPerChild = CompositeTilemap.texturesPerTilemap;
